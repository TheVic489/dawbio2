...
def get_epiweeks_not7days(entries: pd.DataFrame) -> pd.DataFrame:
    ...
    # Convert "from_date" and "to_date" to datetime64
    epiweeks_not7days['from_date'] = pd.to_datetime(epiweeks_not7days['from_date'])
    epiweeks_not7days['to_date']   = pd.to_datetime(epiweeks_not7days['to_date'])

    epiweeks_not7days['Days Diff'] = (epiweeks_not7days['to_date'] - epiweeks_not7days['from_date']).dt.days + 1
